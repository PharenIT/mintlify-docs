...
description: "List Pharen Hub saved lists the API key can read, with team, search, ordering, and pagination filters to discover list UUIDs before reading rows."
