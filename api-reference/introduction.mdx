...
In the API playground, `https://pharen.app` is selected by default. Use the base URL selector when you want to test against another environment, such as a local backend at `http://localhost:8000`.
