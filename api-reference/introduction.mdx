...
Replace `YOUR_API_KEY` with the key you generate in the [Pharen Hub dashboard](https://app.pharen.de/settings/api). See the [Authentication](/api-reference/authentication) page for full details on obtaining and using API keys.
