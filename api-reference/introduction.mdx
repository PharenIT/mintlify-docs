...
Each endpoint page has a **Try it** panel. Set **Authorization** to your Bearer token, then optionally change **baseUrl** from `https://pharen.app` to another origin such as `http://localhost:8000` before sending the request.
