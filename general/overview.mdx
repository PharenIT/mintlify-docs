...
<CardGroup cols={2}>
  ...
  <Card title="Self-host Pharen" icon="server" href="/self-hosting/prerequisites">
    Run a versioned Pharen Hub release on your own Linux infrastructure with Docker Compose.
  </Card>
...
<Steps>
  ...
  <Step title="Deploy it on your infrastructure">
    Use [Self-host Pharen Hub](/self-hosting/prerequisites) if your organization has a self-host license and operates its own Linux servers.
  </Step>
