...
description: "Sende eine Nutzernachricht an einen Pharen Hub KI-Agenten per UUID und streame die Modellantwort über HTTP mit einem agents:run API-Key."
openapi: "openapi.json POST /api/agents/{agent_uuid}/chat/"
---
