...
Der Playground nutzt standardmässig die Produktionsumgebung. Für ein lokales Backend wählst du **Custom URL environment** und setzt **baseUrl** auf `http://localhost:8000`.
