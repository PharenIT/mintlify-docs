...
description: "Führe einen veröffentlichten Pharen Hub Workflow per UUID aus und streame den Knoten-Fortschritt über HTTP mit einem workflows:run API-Key."
